...
<td>Необходимо проанализировать базу данных и сформулировать ценностное предложение для нового продукта. <br>Результат:<br>Даны рекомендации для нового продукта</td>
